...
-View the coins in their spare change
-Go to the send coins view and bank view
* */
public class ViewSpareChange extends AppCompatActivity {
        ...
        db.collection("users").document(curruser).collection("spare change")
            ...
            public void onSuccess(@Nullable QuerySnapshot queryDocumentSnapshots) {
                for(int i = 0; i<queryDocumentSnapshots.size();i++) {
                    //add coins in spare change to the list view
                ...
                arrayAdapter = new ArrayAdapter(ViewSpareChange.this,
                        android.R.layout.simple_list_item_1, coinz);
    ...
    public  void sendcoins(View view) {
        ...
        if (coinz.size()>0) {
            ...
            new ConverterandDialogs().OKdialog("No coins to send, fill up your " +
                            "spare change before trying to send coins.", "No spare change",
                            ViewSpareChange.this).show();
        }
    }
